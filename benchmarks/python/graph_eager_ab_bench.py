...
def _run_matmul_matrix_sub_case(
    *,
    ...
    row = {
        ...
        "graph_plan_score_model": str(plan_summary.get("planner_score_model", "unknown")),
        "graph_plan_cost_profile_signature": str(plan_summary.get("cost_profile_signature", "default")),
        "graph_plan_estimated_total_cost_ns": float(plan_summary.get("estimated_total_cost_ns", float("nan"))),
        "graph_plan_estimated_compute_cost_ns": float(plan_summary.get("estimated_compute_cost_ns", float("nan"))),
        "graph_plan_estimated_launch_cost_ns": float(plan_summary.get("estimated_launch_cost_ns", float("nan"))),
        "graph_plan_estimated_transfer_cost_ns": float(plan_summary.get("estimated_transfer_cost_ns", float("nan"))),
        "graph_plan_estimated_sync_cost_ns": float(plan_summary.get("estimated_sync_cost_ns", float("nan"))),
        "graph_plan_estimated_boundary_cost_ns": float(plan_summary.get("estimated_boundary_cost_ns", float("nan"))),
...
def _unsupported_row(bench: str, shape: str, device: str, reason: str) -> tuple[dict, dict]:
    row = {
        ...
        "graph_plan_score_model": "unsupported",
        "graph_plan_cost_profile_signature": "unsupported",
        "graph_plan_estimated_total_cost_ns": float("nan"),
        "graph_plan_estimated_compute_cost_ns": float("nan"),
        "graph_plan_estimated_launch_cost_ns": float("nan"),
        "graph_plan_estimated_transfer_cost_ns": float("nan"),
        "graph_plan_estimated_sync_cost_ns": float("nan"),
        "graph_plan_estimated_boundary_cost_ns": float("nan"),
...
def _write_csv(path: Path, rows: list[dict]) -> None:
    ...
    fields = [
        ...
        "graph_plan_score_model",
        "graph_plan_cost_profile_signature",
        "graph_plan_estimated_total_cost_ns",
        "graph_plan_estimated_compute_cost_ns",
        "graph_plan_estimated_launch_cost_ns",
        "graph_plan_estimated_transfer_cost_ns",
        "graph_plan_estimated_sync_cost_ns",
        "graph_plan_estimated_boundary_cost_ns",
