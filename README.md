...
Current public release: **v0.1.11** (2026-04-01).
...
# 35. Roadmap
Roadmap baseline is now aligned to **v0.1.11** and tracked in detail in [ROADMAP.md](ROADMAP.md).
...
Phase A (2026 Q2, `v0.1.11`-`v0.2.0`): Runtime Core Hardening
